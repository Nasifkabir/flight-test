    ...
    <div className="mt-8">
      ...
      {hasFlights ? (
        <div className="space-y-4">
          {flightsArray.map((item: any, index: number) => (
            <Card key={index} className="overflow-hidden">
              <CardContent className="p-6">
                ...
                {/* Flight details */}
                {item.flight_group && item.flight_group.map((group: any, groupIndex: number) => (
                  group.routes && group.routes.map((route: any, routeIndex: number) => (
