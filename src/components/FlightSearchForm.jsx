...
// Bangladeshi airports data
const bangladeshiAirports = [
  ...
  { code: 'JSR', name: 'Jashore - Jashore Airport' },
  { code: 'SPD', name: 'Saidpur - Saidpur Airport' },
  { code: 'RJH', name: 'Rajshahi - Shah Makhdum Airport' },
  { code: 'CXB', name: 'Cox\'s Bazar - Cox\'s Bazar Airport' },
  { code: 'BZL', name: 'Barisal - Barisal Airport' }
];
...
const FlightSearchForm = ({ onSearch, isLoading }) => {
  ...
  const [departureDate, setDepartureDate] = useState(new Date('2025-06-06'));
  const [returnDate, setReturnDate] = useState(new Date('2025-06-13'));
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="space-y-2">
          ...
          <Select value={departure} onValueChange={setDeparture}>
            ...
            <SelectContent>
              {bangladeshiAirports.map((airport) => (
